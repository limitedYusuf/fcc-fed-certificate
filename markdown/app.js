$(document).ready(function () {
   const initialMarkdown = `# Welcome to Yusuf Markdown Previewer!
...
`;
   ...
   $('#editor').val(initialMarkdown);
   $('#preview').html(marked(initialMarkdown, { breaks: true }));

   // Update preview as you type in the editor
